...
<div class="container h-100">
    <div class="d-flex justify-content-center h-100">
        <div class="user_card">
            ...
            <h5 style="color: #878787;text-align: center; font-family: 'Prompt'; font-weight: 300;">สำหรับลูกค้า</h5>
            <div class="d-flex justify-content-center form_container">
                <form method="POST" action="{{route('login')}}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="อีเมล" value="{{ old('email') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="customControlInline" style="font-family: 'Prompt'; font-weight: 300; font-size: 16px;">จดจำรหัสผ่าน</label>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center mt-3 login_container">

                        <button type="submit" name="button" class="btn login_btn" >{{ __('เข้าสู่ระบบ') }}</button>

{{--                        @if (Route::has('password.request'))--}}
{{--                            <a class="btn btn-link btn-lg" href="{{ route('password.request') }}" style="font-family: 'Prompt Light'; font-size: small;">--}}
...
{{--                        @endif--}}
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-center links" style="font-family: 'Prompt'; font-weight: 300;">
                    ...
                    ยังไม่มีบัญชีใช่หรือไม่?<a href="{{ route('register') }}" class="ml-2">สมัครสมาชิก</a>
{{--                    If you want to be partners <a href="{{ route('partner-register') }}" class="ml-2">Sign Up Partner</a>--}}
                </div>
