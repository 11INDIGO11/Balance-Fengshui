                    ...
                    <div class="col-sm-12">
                        <div class="picture-container">
                            ...
                            <div class="form-group"><!----name---->
                                ...
                                <input id="partner_name" style="font-family: 'Prompt'; font-weight: 300;"  type="name" class="form-control @error('partner_name') is-invalid @enderror" name="partner_name" value="{{ old('partner_name') }}" required autocomplete="partner_name" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input style="font-family: 'Prompt'; font-weight: 300;" id="location" type="location"  name="location" placeholder="Enter Address Here.." class="form-control @error('location') is-invalid @enderror" value="{{ old('location') }}" required autocomplete="location" autofocus>
                            @error('location')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-sm-4 form-group"><!----Email---->
                                ...
                                <input style="font-family: 'Prompt'; font-weight: 300;" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                            ...
                            <div class="col-sm-4 form-group"><!----pass---->
                                ...
                                <input style="font-family: 'Prompt'; font-weight: 300;" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input style="font-family: 'Prompt'; font-weight: 300;" id="partner_phonenumber" type="phonenumber" name="partner_phonenumber" placeholder="09-123-45678" class="form-control" value="{{ old('partner_phonenumber') }}">
                            </div>
                            <div class="col-sm-6 form-group">
                                <label style="color: #878787; font-family: 'Prompt'; font-weight: 300; font-size: 20px;">เว็บไซต์ หรือ เพจ</label>
                                <input style="font-family: 'Prompt'; font-weight: 300;" id="contract" type="contract" name="contract" placeholder="www.xxx.com/facbook" class="form-control" value="{{ old('contract') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="color: #878787; font-family: 'Prompt'; font-weight: 300; font-size: 20px;">ประสบการณ์</label>
                            <input style="font-family: 'Prompt'; font-weight: 300;" type="number" id="experience"  name="experience" class="form-control" value="{{ old('experience') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn login_btn form-control">{{ __('สมัครสมาชิก') }}</button>
                        </div>
