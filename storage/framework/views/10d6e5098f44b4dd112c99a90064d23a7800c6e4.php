...
unset($__errorArgs, $__bag); ?>" name="email" placeholder="อีเมล" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="พาสเวิร์ด" required autocomplete="current-password">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-center mt-3 login_container">
                        ...
                        <button type="submit" name="button" class="btn login_btn" ><?php echo e(__('เข้าสู่ระบบ')); ?></button>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-center links" style="font-family: 'Prompt'; font-weight: 300;">
                    ...
                    ยังไม่มีบัญชีใช่หรือไม่?<a href="<?php echo e(route('register')); ?>" class="ml-2">สมัครสมาชิก</a>

                </div>
                <div class="d-flex justify-content-center links">
                    <a href="<?php echo e(route('password.request')); ?>" style="font-family: 'Prompt'; font-weight: 300;">ลืมรหัสผ่านใช่หรือไม่?</a>
                </div>
            </div>
        </div>
    </div>
