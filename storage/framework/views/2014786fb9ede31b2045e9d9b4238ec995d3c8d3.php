        ...
        <form method="POST" action="<?php echo e(route('comments.store')); ?>">
            ...
            <?php if(isset($guest_commenting) and $guest_commenting == true): ?>
                <div class="form-group">
                    <label for="message">กรอกชื่อของคุณ :</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="message">กรอกอีเมล์ของคุณ :</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label for="message">กรอกข้อความของคุณ :</label>
                <textarea class="form-control <?php if($errors->has('message')): ?> is-invalid <?php endif; ?>" name="message" rows="3"></textarea>
                <div class="invalid-feedback">
                    โปรดกรอกข้อความ
                </div>
            </div>
            <button type="submit" class="btn" id="sendComment" style="width: 30%; float: right">ส่งข้อความ</button>
        </form>
    </div>
</div>
<br />

<?php /**PATH C:\xampp\htdocs\fengshui_webapp\resources\views/vendor/comments/_form.blade.php ENDPATH**/ ?>