    ...
    <div class="container">
        <div class="register-form">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                <?php echo csrf_field(); ?>
                <input style="font-family: 'Prompt'; font-weight: 300;" id="user_name" type="text" class="form-control <?php $__errorArgs = ['user_name'];
...
unset($__errorArgs, $__bag); ?>" name="user_name" value="<?php echo e(old('user_name')); ?>" required autocomplete="name" autofocus placeholder="ชื่อ" >
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" placeholder="อีเมล์">
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="new-password" placeholder="พาสเวิร์ด">
...
<?php /**PATH C:\xampp\htdocs\fengshui_webapp\resources\views/auth/register.blade.php ENDPATH**/ ?>