    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div class="container" style="text-align: center; font-family: 'Prompt Light';font-size: 36px;">
            <button type="button" class="btn btn-warning btn-lg" style="background-color: #F9C414;">ห้องนอน</button>
            <button type="button" class="btn btn-secondary btn-lg">ห้องนั่งเล่น</button>
            <button type="button" class="btn btn-secondary btn-lg">ห้องครัว</button>
            <button type="button" class="btn btn-secondary btn-lg">ห้องน้ำ</button>
            <button type="button" class="btn btn-secondary btn-lg">ห้องพระ</button>
        ...
        <div class="container" style="width: 60%;">
            ...
            <div class="row" style="text-align: center">
                <img src="https://sv1.picz.in.th/images/2020/10/17/b7sFII.png" class="col" style="width: 50%;height: 50%;">
            ...
            <h6 style="font-family: 'Prompt Light';text-align: center;">เฟอร์นิเจอร์อาจจะต้องมีลักษณะเป็นสีเหลี่ยม
                ผืนผ้า หรืออาจเป็นวัสดุที่ทำจากไม้ หรือลักษณะของเฟอร์นิเจอร์ อาจมีความโค้งมน
                คล้ายกับคลื่นของน้ำ มีลักษณะรูปทรงที่ไม่แน่นอน
                เพราะว่าธาตุน้ำ สามารถส่งเสริม ธาตุไม้ได้เช่นกัน
            </h6>
        </div>
        <br>
        <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fengshui_webapp\resources\views/detailcontent_bedroom.blade.php ENDPATH**/ ?>
